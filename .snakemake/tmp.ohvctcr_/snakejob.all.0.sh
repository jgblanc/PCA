...
--wait-for-files /project2/jjberg/jgblanc/PCA/.snakemake/tmp.ohvctcr_ output/figures/ALL/ALL_0.01_PCA.png output/figures/ALL/ALL_0.01.50_5_0.5.png --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules all --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.ohvctcr_/0.jobfinished || (touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.ohvctcr_/0.jobfailed; exit 1)
