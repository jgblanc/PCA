...
--wait-for-files /project2/jjberg/jgblanc/PCA/.snakemake/tmp.871viog4 output/PCA/ALL/ALL_0.01.eigenvec --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules plot_pca --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.871viog4/1.jobfinished || (touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.871viog4/1.jobfailed; exit 1)
