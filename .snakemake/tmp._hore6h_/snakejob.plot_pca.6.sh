...
--wait-for-files /project2/jjberg/jgblanc/PCA/.snakemake/tmp._hore6h_ output/PCA/MX/MX_0.01.eigenvec --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules plot_pca --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp._hore6h_/6.jobfinished || (touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp._hore6h_/6.jobfailed; exit 1)
