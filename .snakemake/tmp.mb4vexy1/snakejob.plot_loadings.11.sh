...
--wait-for-files /project2/jjberg/jgblanc/PCA/.snakemake/tmp.mb4vexy1 output/PCA/SAS/SAS_0.01.eigenvec.var.evo output/pruned/SAS/SAS_0.01.50_5_0.5.DA.prune.in --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules plot_loadings --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.mb4vexy1/11.jobfinished || (touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.mb4vexy1/11.jobfailed; exit 1)
