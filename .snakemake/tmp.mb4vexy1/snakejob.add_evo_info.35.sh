...
--wait-for-files /project2/jjberg/jgblanc/PCA/.snakemake/tmp.mb4vexy1 output/PCA/MX/MX_0.01.eigenvec.var --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
  -p --allowed-rules add_evo_info --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.mb4vexy1/35.jobfinished || (touch /project2/jjberg/jgblanc/PCA/.snakemake/tmp.mb4vexy1/35.jobfailed; exit 1)
